...
OUTPUT_DIR = SCRIPT_DIR / f"results_Random_Forest"
...
def save_confusion_matrix(cm):
    ...
    plt.ylabel("Actual")
    plt.title(f"Random_Forest Confusion Matrix")
    plt.tight_layout()
...
def main():
    ...
    plt.title(f"Random_Forest ROC Curve")
    plt.legend()
    plt.tight_layout()
    ...
    plt.title(f"Random_Forest Precision-Recall Curve")
    plt.legend()
    plt.tight_layout()
    ...
    plt.title(f"Random_Forest Calibration Curve")
    plt.legend()
    plt.tight_layout()
    ...
    plt.xlabel("Cutoff")
    plt.ylabel("Metric")
    plt.title(f"Random_Forest Cutoff Analysis")
    plt.legend()
    plt.tight_layout()
    ...
    plt.ylabel("Marker")
    plt.title(f"Random_Forest Permutation Importance")
    plt.tight_layout()
    ...
    pd.DataFrame({
        ...
        OUTPUT_DIR / "random_forest_feature_importance.xlsx",
        index=False
    )
