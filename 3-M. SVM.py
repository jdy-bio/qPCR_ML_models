...
MODEL_NAME = "SVM_RBF"
OUTPUT_DIR = SCRIPT_DIR / f"results_SVM_RBF"
...
def save_confusion_matrix(cm):
    ...
    plt.ylabel("Actual")
    plt.title(f"SVM_RBF Confusion Matrix")
    plt.tight_layout()
...
def main():
    ...
    plt.title(f"SVM_RBF Precision-Recall Curve")
    plt.legend()
    plt.tight_layout()
    ...
    plt.title(f"SVM_RBF Calibration Curve")
    plt.legend()
    plt.tight_layout()
    ...
    plt.xlabel("Cutoff")
    plt.ylabel("Metric")
    plt.title(f"SVM_RBF Cutoff Analysis")
    plt.legend()
    plt.tight_layout()
    ...
    plt.ylabel("Marker")
    plt.title(f"SVM_RBF Permutation Importance")
    plt.tight_layout()
